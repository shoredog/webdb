...
include("header.php"); ?>
    <div class="content3">
    	<img src="afbeeldingen/contact.jpg" class="bnnr" /> 
        <?php
...
$mail_ontv = 'dve@live.nl'; // <<<----- voer jouw e-mailadres hier in!
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    {
        $seconde = 3600; // 20 seconden voordat dezelfde persoon nog een keer een e-mail mag versturen
