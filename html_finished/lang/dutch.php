...
//-------------------- REGISTER (PREFIX: reg) ------------------------
$reg = "Registratie";
$regform = "Registratieformulier";
$reginfo = "Vul hier uw gegeven in:";
$regname = "Gebruikersnaam";
$regrepmail = "Herhaal e-mail";
$regsex = "Geslacht";
$regbday = "Geboortedag";
$regloc = "Locatie";
$regagree = "Ik heb de gebruikersvoorwaarde gelezen en ga akkoord";
$regbutton = "<input type=\"submit\" value=\"Verstuur\" name=\"send\" />";
...
$gebpannotepad = "Persoonlijk kladblok";
$gebpannotepadempty = "Hier kunt u informatie opslaan welke u later nog kunt gebruiken.";
$gebpanforumsettings = "Foruminstellingen";
$gebpanchangeava = "Avatar wijzigen";
...
$gebpanlang = "Taal";
$gebpanstyle = "Forumopmaak";
$gebpanprofilesettings = "Profielinstellingen";
$gebpansex = "Geslacht";
$gebpanman = "Man";
$gebpanwoman = "Vrouw";
...
$gebpanbio = "Biografie";
$gebpannotlogged = "U bent niet ingelogd, en daarom heeft u geen toegang tot het Gebruikers Controle Paneel.";
